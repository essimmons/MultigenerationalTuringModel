function [U_tot,V_tot,x,y] = ImplicitRxnDiff2D(param,D_u,D_v,w,N,axisSize)
% Example input: [U_tot,V_tot,x,y] = Mim4x4ImplicitRxnDiff2D(4,param_PA,param_PA.D_u,param_PA.D_v,50,50,5)
% In param, D_u and D_v are input parameters from the system.
% M is 4x1 vector for trans-interaction.
% w is the wavelength expected from instability calculations.
% N is how many mesh points to use in x and y directions (for N^2 squares
% in the plot).
% axisSize is number of wavelengths to plot. I.e. if w=50 and axisSize=5, a
% spatial scale of 250 units will be simulated.
